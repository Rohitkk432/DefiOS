...
const Homepage: React.FC<HomepageProps> = ({}) => {
    return (
        <div className='w-screen h-screen homepageGradient px-[6%] py-[2%] text-white flex flex-col justify-start items-center'>
            ...
            {/* backdrop globe */}
            <div className='h-full w-[88%] absolute top-[0%] overflow-hidden z-index-1'>
                <img src="/assets/images/backdrop.png" className='h-full m-auto' />
            </div>

            {/* navbar */}
            <div className='w-full flex flex-row justify-between items-center h-[7vh] z-index-2'>
                ...
                <div className='flex flex-row justify-end items-center w-full h-full' >
                    ...
                    <div className='mx-[2%] font-thin text-[2.5vh]'>Contact Us <FontAwesomeIcon icon={faSquareArrowUpRight}  /> </div>
                </div>
            </div>

            <div className='h-full w-full flex justify-center items-center z-index-2'>
                <div className=''>
                    ...
                    <div className='flex flex-row justify-center items-center w-full text-[#1D242D] text-[2vh] font-semibold'>
                        <button className='bg-[#D1D2D2] py-[2.5%] w-[27%] rounded-[0.75vh] mx-[2%]' ><FontAwesomeIcon icon={faSquareArrowUpRight} className='mr-[2%]' /> Get Started</button>
                        <button className='bg-[#7082C3] py-[2.5%] w-[27%] rounded-[0.75vh] mx-[2%]' ><FontAwesomeIcon icon={faSquareArrowUpRight} className='mr-[2%]' /> Latest Updates</button>
                    </div>
                </div>
            </div>
