...
const ReposOption: React.FC<ReposOptionProps> = ({repo}) => {
    ...
    return (
        <div className='bg-[#121418] w-full h-[18%] px-[2%] py-[2%] mt-[2%] text-xs font-semibold rounded-md border-[#2E2E2F] border relative' >
            {/* repo visibility */}
            <div className={`absolute top-[10%] right-[2%] border border-[#3A4E70] rounded px-[4%] py-[0.5%] ${fontsizer3} text-[#B5C3DB] `} >{repo.visibility}</div>
            {/* repo name */}
