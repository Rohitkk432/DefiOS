...
const LoadingScreen: React.FC<LoadingScreenProps> = ({load}) => {
    return (
        <div className={`w-screen h-screen absolute z-100 top-0 left-0 bg-[rgba(0,0,0,0.6)] 
        ${load?'flex':'hidden'} justify-center items-center flex-col`}>
            ...
            <div className='mt-[2vh] text-[3.5vh] text-[#CDCDCD]' >Processing</div>
        </div>
    );
}
