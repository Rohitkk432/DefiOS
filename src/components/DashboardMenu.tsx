...
const DashboardMenu: React.FC<DashboardMenuProps> = ({}) => {
    ...
    return (
        <div className='w-[20%] h-full bg-[#191C21] flex flex-col justify-end items-center px-[1.5%] py-[1%] relative text-white'>
            <Link href='/'>
                <img src="/assets/images/defi-os-logo.png" className='h-[6vh] absolute top-[2.5%] left-[6%]' />
            </Link>
            <img src={session?.user?.image || ''} className='w-[25%] mb-[2%] rounded-full' />
            <div className='text-[#CACACA] mb-[6%] text-[2.5vh]'>Hey! {session?.user?.name || ''}</div>
            
            {/* options */}
            <div className='w-full h-[4.5%] mb-[2%] rounded-md bg-[#121418] flex flex-row justify-between items-center px-[7%]'>
            ...
            <a href="https://github.com/" target="_blank" className='w-full h-[4.5%] mb-[2%] rounded-md flex flex-row justify-between items-center px-[7%] hover:border hover:border-gray-400 '>
                <div className='flex flex-row justify-start items-center w-[70%] h-full'>
                    <img src='/assets/images/bulbPuzzleIcon.svg' className='h-[2.7vh] w-[2.7vh] mr-[8%]'/>
                    <div className='text-[1.6vh]' >Biggest Solve</div>
                </div>
            </a>
            <div className='w-full h-[4.5%] mb-[2%] rounded-md flex flex-row justify-between items-center px-[7%]'>
                <div className='flex flex-row justify-start items-center w-[70%] h-full'>
            ...
            <div className='w-full h-[34%] overflow-y-scroll customScrollbar'>
                <ActionableItems />
                <ActionableItems />
                <ActionableItems />
            </div>
